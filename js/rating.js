new Vue({
    ...
    methods: {
        rating: function () {
            fetch("https://lichess.org/api/user/" + this.jogadorSelecionado)
                ...
                .then((data) => {
                    ...
                    this.ratingNow.correspondence =
                        data.perfs.correspondence.rating;
                    this.ratingStarting.correspondence =
                        data.perfs.correspondence.rating;
        ...
        diferenca: function () {
            ...
            this.ratingDiff.blitz =
                this.ratingNow.blitz - this.ratingStarting.blitz;

            this.ratingDiff.rapid =
                this.ratingNow.rapid - this.ratingStarting.rapid;
