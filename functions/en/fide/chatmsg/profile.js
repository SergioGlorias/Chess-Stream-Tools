export async function onRequest(context) {
    ...
    return new Response(`${name} has ${ranting.blitz_rating} Blitz, ${ranting.rapid_rating} Rapid and ${ranting.classical_rating} Classical! https://ratings.fide.com/profile/${userParam}/chart`)
