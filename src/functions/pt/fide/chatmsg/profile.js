export async function onRequest(context) {
  ...
  return new Response(
    `${name} tem ${ranting.blitz_rating} Rápidas, ${ranting.rapid_rating} Semi-Rápidas e ${ranting.classical_rating} Classicas! https://ratings.fide.com/profile/${userParam}/chart`
  );
}
